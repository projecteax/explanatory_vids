"""Create a clean master, production timeline, and Rhubarb mouth cues."""
...
PUBLIC_DATA = ROOT / "explainer" / "src" / "production-data"
RHUBARB = (
    ROOT
    / "tools"
    / "rhubarb"
...
def main() -> None:
    ...
    master_wav = PUBLIC_AUDIO / "moon_full_clean.wav"
    ...
    payload = {
        ...
        "audio": "audio/moon_full_clean.wav",
        "lines": timeline,
    }
    ...
    print(
        f"Wrote clean master ({probe(master_wav):.3f}s), timeline and Rhubarb cues"
    )
